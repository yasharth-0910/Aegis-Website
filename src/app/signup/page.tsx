...
export default function SignupPage(){
    ...
    return(
        <div className="h-screen w-screen bg-gradient-to-br from-[#ff5a5f] to-[#ff4449] flex items-center justify-center p-4 overflow-hidden">
            <div className="w-full max-w-sm flex flex-col justify-center">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-xl border border-white/20">
                    <div className="text-center mb-4">
                        ...
                        <p className="text-white/80 text-xs">Join us to get started</p>
                    </div>
